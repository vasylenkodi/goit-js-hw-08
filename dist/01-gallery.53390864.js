...
const galleryPreviewImagesToCreate = (0, _galleryItems.galleryItems).map((galleryItem)=>{
...
// ---------------------СОЗДАНИЕ ЛАЙТБОКСА--------------------------
const lightbox = new (0, _simplelightboxDefault.default)(".gallery .gallery__item", {
